...
import co.com.banco.jpa.repository.client.ClientRepository;
import co.com.banco.jpa.repository.client.ClientRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    void setUp() {
        ...
        adapter = new ClientRepositoryAdapter(repository, objectMapper);
    }
